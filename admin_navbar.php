    ...
    if (isset($_SESSION['login_admin_username'])) {
        ...
        <div class="header">
            <div class="container">
                <div class="navbar">
                    <div class="logo">
                        <a href="index.php"><img src="images/logo2.jpg" width="30px" height="30px" alt="Logo"
                                style="border-radius: 50%;"></a>
                    </div>
                    <div class="admin-title">
                        <a href="index.php">
                            <h3 style="font-size: 16px;">Online Library Management System</h3>
                        </a>
                    </div>
                        ...
                        <ul id="menuitems">
                            ...
                            <li><a href="admin_message.php" id="envelope"><i class="fas fa-envelope"></i>
                                    ...
                                    if ($c['total'] > 0 && $c['total'] <= 9) {
                                        ?>
                                        <sup
                                            style="border-radius: 50px; background-color: red; padding: 0 5px;"><?php echo $c['total']; ?></sup>
                                        <?php
                                    } else if ($c['total'] > 9) {
                                        ?>
        ...
        <div class="header">
            <div class="container">
                <div class="navbar">
                    ...
                    <div class="title">
                        <a href="index.php">
                            <h3 style="font-size: 20px;">Online Library Management System</h3>
                        </a>
                    </div>
                    <nav>
                        <ul id="menuitems">
